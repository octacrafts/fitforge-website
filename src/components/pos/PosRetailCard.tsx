...
export default function PosRetailCard({
  ...
  return (
    <article className="flex h-full flex-col rounded-[24px] border border-card-line bg-card-dark p-6 sm:p-7">
      ...
      <div className="mt-auto flex items-start gap-3 rounded-2xl bg-ink-dark p-4">
